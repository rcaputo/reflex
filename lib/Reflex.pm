...
programs.  In short, Reflex aims to allow programmers to write 
events based programs completely OO approach (using Moose).
This makes using event-based libraries such as POE a lot simpler
and cleaner. 
